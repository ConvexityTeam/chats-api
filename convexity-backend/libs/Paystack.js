...
class Paystack {
    ...
    */
    confirmDeposit(transactionId) {
        return new Promise((resolve, reject) => {
            const options = {
                ...
                method: 'GET',
                headers: { Authorization: 'Bearer ' + process.env.PAYSTACK_SECRET_KEY_TEST }
            };
    ...
    getBankList() {
        return new Promise((resolve, reject) => {
            const options = {
                url: 'https://api.paystack.co/bank'||'http://127.0.0.1/code-lab/banks.json',
                method: 'GET',
                headers: { Authorization: 'Bearer ' + process.env.PAYSTACK_SECRET_KEY_TEST }
            };
            request(options, (err, res, body) => {
    ...
    transferRecipients(accountNumber = '0164063227', bankCode = '058', name = "Habeeb Salami Alabi") {
        return new Promise((resolve, reject) => {
            const payload = {
                "type": "nuban",
                "name": name,
